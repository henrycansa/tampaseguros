...
const content = productsEs.descuento;

export const metadata: Metadata = {
  title: content.metaTitle,
  description: content.metaDescription,
  alternates: hreflang("/planes-medico-de-descuento/", "/en/medical-discount-plans/", "es"),
};

const breadcrumbItems = [
  { name: "Inicio", path: "/" },
  { name: "Seguros Personales", path: "/seguros-personales/" },
  { name: content.breadcrumbName, path: "/planes-medico-de-descuento/" },
];

export default function PlanesMedicoDeDescuentoPage() {
