...
const content = productsEn.funeral;

export const metadata: Metadata = {
  title: content.metaTitle,
  description: content.metaDescription,
  alternates: hreflang("/plan-funeral/", "/en/funeral-plan/", "en"),
};

const breadcrumbItems = [
  { name: "Home", path: "/en" },
  { name: "Personal Insurance", path: "/en/personal-insurance/" },
  { name: content.breadcrumbName, path: "/en/funeral-plan/" },
];

export default function FuneralPlanPage() {
