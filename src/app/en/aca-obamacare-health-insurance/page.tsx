...
const content = productsEn.obamacare;

export const metadata: Metadata = {
  title: content.metaTitle,
  description: content.metaDescription,
  alternates: hreflang("/seguro-medico-obamacare/", "/en/aca-obamacare-health-insurance/", "en"),
};

const breadcrumbItems = [
  { name: "Home", path: "/en" },
  { name: "Personal Insurance", path: "/en/personal-insurance/" },
  { name: content.breadcrumbName, path: "/en/aca-obamacare-health-insurance/" },
];

export default function AcaObamacareHealthInsurancePage() {
